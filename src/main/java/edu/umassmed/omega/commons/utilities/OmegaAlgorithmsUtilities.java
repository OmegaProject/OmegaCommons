...
public class OmegaAlgorithmsUtilities {
	...
	private static String DEFAULT_IMPORTER_ALGO_SNAME = "OMEGA DI";
	...
	private static String DEFAULT_TRACKING_MEASURES_DIFF_ALGO_SNAME = "OMEGA DM";
	...
	private static String DEFAULT_TRACKING_MEASURES_MOBI_ALGO_SNAME = "OMEGA MM";
	...
	private static String DEFAULT_TRACKING_MEASURES_VELO_ALGO_SNAME = "OMEGA VM";
	...
	private static String DEFAULT_TRACKING_MEASURES_INTE_ALGO_SNAME = "OMEGA IM";
	...
	private static String DEFAULT_SEGMENTATION_ALGO_SNAME = "OMEGA TS";
	...
	private static String DEFAULT_RELINKING_ALGO_SNAME = "OMEGA TE";
	...
	static {
		OmegaAlgorithmsUtilities.DEFAULT_TRACKING_MEASURES_DIFF_PARAMS
				.add(new OmegaParameter(
						...
						OmegaAlgorithmParameterConstants.PARAM_DIFFUSIVITY_WINDOW_3));
		OmegaAlgorithmsUtilities.DEFAULT_TRACKING_MEASURES_DIFF_PARAMS
				.add(new OmegaParameter(
						OmegaAlgorithmParameterConstants.PARAM_DIFFUSIVITY_LOG_OPTION,
						OmegaAlgorithmParameterConstants.PARAM_DIFFUSIVITY_LOG_OPTION_LOG_ONLY));
		OmegaAlgorithmsUtilities.DEFAULT_TRACKING_MEASURES_DIFF_PARAMS
				.add(new OmegaParameter(
						OmegaAlgorithmParameterConstants.PARAM_ERROR_OPTION,
						OmegaAlgorithmParameterConstants.PARAM_ERROR_OPTION_DISABLED));
		...
		final OmegaAlgorithmInformation algoInfoRelinking = new OmegaAlgorithmInformation(
				...
				OmegaAlgorithmsUtilities.DEFAULT_RELINKING_ALGO_SNAME,
		...
		final OmegaAlgorithmInformation algoInfoSegmentation = new OmegaAlgorithmInformation(
				...
				OmegaAlgorithmsUtilities.DEFAULT_SEGMENTATION_ALGO_SNAME,
		...
		final OmegaAlgorithmInformation algoInfoTrackingMeasuresDiff = new OmegaAlgorithmInformation(
				...
				OmegaAlgorithmsUtilities.DEFAULT_TRACKING_MEASURES_DIFF_ALGO_SNAME,
		...
		final OmegaAlgorithmInformation algoInfoTrackingMeasuresMobi = new OmegaAlgorithmInformation(
				...
				OmegaAlgorithmsUtilities.DEFAULT_TRACKING_MEASURES_MOBI_ALGO_SNAME,
		...
		final OmegaAlgorithmInformation algoInfoTrackingMeasuresVelo = new OmegaAlgorithmInformation(
				...
				OmegaAlgorithmsUtilities.DEFAULT_TRACKING_MEASURES_VELO_ALGO_SNAME,
		...
		final OmegaAlgorithmInformation algoInfoTrackingMeasuresInte = new OmegaAlgorithmInformation(
				...
				OmegaAlgorithmsUtilities.DEFAULT_TRACKING_MEASURES_INTE_ALGO_SNAME,
		...
		final OmegaAlgorithmInformation algoInfoTracksImporter = new OmegaAlgorithmInformation(
				...
				OmegaAlgorithmsUtilities.DEFAULT_IMPORTER_ALGO_SNAME,
