...
public class OmegaImporterEventResultsOmegaTrajectoriesRelinking extends
		OmegaImporterEventResultsOmegaParticleLinking {
	
	public OmegaImporterEventResultsOmegaTrajectoriesRelinking(
		...
		super(source, container, parents, analysisData, paramData,
				resultingTrajectories, completeChainAfterImport);
	}
}
