...
public class OmegaImporterEventResultsGeneralParticleTracking extends
		OmegaImporterEventResultsGeneralParticleDetection {

	private final List<OmegaTrajectory> resultingTrajectories;

	public OmegaImporterEventResultsGeneralParticleTracking(
		...
		super(source, container, analysisData, paramData, resultingParticles,
				resultingParticlesValues, completeChainAfterImport);
