...
public class OmegaDiffusivityAnalyzer implements Runnable {
	...
	public OmegaDiffusivityAnalyzer(
		...
		this(null, segmRun, segments, params, null, null, null);
	}
	...
	public OmegaDiffusivityAnalyzer(
	        ...
	        final Map<OmegaTrajectory, List<OmegaSegment>> segments,
	        final List<OmegaParameter> params) {
		this(displayerPanel, null, segments, params, null, null, null);
	}
	...
	public OmegaDiffusivityAnalyzer(
		...
		this(displayerPanel, segmRun, segments, params, snrRun, null, null);
	}
