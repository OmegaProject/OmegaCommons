...
public abstract class OmegaLoaderPluginArchetype extends OmegaPluginArchetype implements
        OmegaLoaderPluginInterface, OmegaMainDataConsumerPluginInterface {

	private OmegaGateway gateway;
	private OmegaData omegaData;

	public OmegaLoaderPluginArchetype() {
		this(1);
	}

	public OmegaLoaderPluginArchetype(final int numOfPanels) {
		super(numOfPanels);
