...
public abstract class OmegaTrajectorySegmentationPluginArchetype extends
	...
	public OmegaTrajectorySegmentationPluginArchetype() {
		this(1);
	}
	
	public OmegaTrajectorySegmentationPluginArchetype(final int numOfPanels) {
		super(numOfPanels);
