...
public abstract class OmegaAlgorithmPluginArchetype extends OmegaPluginArchetype {
	
	private OmegaAlgorithmInformation algoInfo;
	
	public OmegaAlgorithmPluginArchetype() {
		this(1);
	}
	
	public OmegaAlgorithmPluginArchetype(final int maxNumOfPanels) {
