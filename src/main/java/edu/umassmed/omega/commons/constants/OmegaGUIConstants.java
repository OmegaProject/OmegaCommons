...
public class OmegaGUIConstants {
	...
	public static final String SIDEPANEL_ITEM_SELECTED = "Selected Item: ";
	public static final String SIDEPANEL_NO_ITEM_SELECTED = "No Selected Item";
	...
	public static final String SIDEPANEL_TABS_TRACKS = "Tracks";

	public static final String SIDEPANEL_INFO_ID = " ID: ";
	public static final String SIDEPANEL_INFO_OWNER = "Owner: ";
	public static final String SIDEPANEL_INFO_NAME = "Name: ";
	public static final String SIDEPANEL_INFO_NOT_NAMED = "Item Not Named";
	public static final String SIDEPANEL_INFO_NUM_DATASET = "Number of Datasets: ";
	public static final String SIDEPANEL_INFO_NUM_IMAGES = "Number of Images: ";
	public static final String SIDEPANEL_INFO_NUM_ANALYSIS = "Times Analyzed: ";
	public static final String SIDEPANEL_INFO_ACQUIRED = "Acquired: ";
	public static final String SIDEPANEL_INFO_IMPORTED = "Imported: ";
	public static final String SIDEPANEL_INFO_DIM_XY = "Dimensions (XY): ";
	...
	public static final String SIDEPANEL_RENDERING_Z = "Z Sections";
	public static final String SIDEPANEL_RENDERING_T = "Timepoints (Time)";
	...
	public static final String SIDEPANEL_RENDERING_C = "Channels";

	public static final String SIDEPANEL_TRACKS_SHOWATT = "Show Tracks Starting At Current Timepoint";
	public static final String SIDEPANEL_TRACKS_SHOWUPT = "Show Tracks Up To Current Timepoint";
	public static final String SIDEPANEL_TRACKS_ACTIVEONLY = "Show Only Active Tracks";
	...
	public static final String SIDEPANEL_TRACKS_OVERLAY_TRACKS = "Tracks";
	public static final String SIDEPANEL_TRACKS_OVERLAY_ADJ = "Relinked Tracks";
	public static final String SIDEPANEL_TRACKS_OVERLAY_SEGM = "Segmented Tracks";
	...
	public static final String TOPPANEL_PLUGINMENU_SNR_ESTIMATOR = "SNR Estimator";
